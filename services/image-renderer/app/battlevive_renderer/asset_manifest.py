...
_configured_assets_dir = os.environ.get("BATTLEVIVE_ASSETS_DIR")
ASSETS_DIR = (
    Path(_configured_assets_dir)
    if _configured_assets_dir
    else Path(__file__).resolve().parents[4] / "assets"
)
MAP_MANIFEST_PATH = ASSETS_DIR / "maps" / "manifest.json"
